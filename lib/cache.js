...
var legacyConfigSupport = function (config) {
    if (config.redisHost || config.redisPort) {
        console.log('WARNING: old redis syntax is deprecated! Please migrate to ' +
 ...
 */
Cache.prototype.isBackendSleeping = function (host, callback) {
    this.log('Checking if ' + host + ' is sleeping.');
    this.client.isBackendSleeping(host, callback);
}
